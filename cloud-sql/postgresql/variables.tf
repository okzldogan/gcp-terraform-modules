...
variable "instance_deletion_protection" {
  description = "Set to true to protect your instances from accidental deletion across all surfaces (API, gcloud, Cloud Console and Terraform), use the API flag."
  type        = bool
  default     = true
}
