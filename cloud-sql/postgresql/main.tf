...
resource "google_sql_database_instance" "default" {
  ...
  settings {
    ...
    deletion_protection_enabled = var.instance_deletion_protection
    ...
    dynamic "ip_configuration" {
      ...
      content {
        ...
        enable_private_path_for_google_cloud_services = lookup(ip_configuration.value, "private_path", null)
