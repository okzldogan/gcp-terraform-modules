...
resource "google_service_account_iam_member" "wif-sa" {
  ...
  member             = "principalSet://iam.googleapis.com/${google_iam_workload_identity_pool.main.name}/${each.value.attribute}"
                      # Set Member for a specific branch in a repo
                      #"principal://iam.googleapis.com/${google_iam_workload_identity_pool.main.name}/subject/repo:my-org/my-repo:ref:refs/heads/main" 
}