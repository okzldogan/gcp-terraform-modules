...
variable "gcs_fuse_csi_driver_config" {
  type        = bool
  description = "The status of the GCS FUSE CSI driver addon, which allows the usage of Cloud Storage Buckets as volumes."
  default     = false
}
...
variable "security_posture_mode" {
  type        = string
  description = "(Beta) Whether this cluster should enable the GKE Security Posture Feature. Set to BASIC to enable it."
  default     = "MODE_UNSPECIFIED"
}

variable "security_posture_vulnerability_mode" {
  type        = string
  description = "(Beta) Whether this cluster should enable the GKE Security Posture Workload Vulnerability Scan. Set to VULNERABILITY_BASIC to enable it."
