resource "google_compute_disk_resource_policy_attachment" "attachment" {
  name = google_compute_resource_policy.zonal_disk_snapshot_policy.name
  disk = var.disk_name
  zone = var.disk_zone
...
resource "google_compute_resource_policy" "zonal_disk_snapshot_policy" {
  name = var.disk_snapshot_policy_name
