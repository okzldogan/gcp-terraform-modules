...
variable "k8s_namespace" {
  description = "Set the Kubernetes namespace for the security findings container."
  type        = string
}

variable "k8s_deployment_name" {
  description = "Kubernetes deployment from which security findings will be exported."
  type        = string
}
